...
namespace Tmpl8
{
    ...
    public:
        ...
        TouchType getCollisionType(vec2& new_pos);
...
namespace Tmpl8
{
    ...
    TouchType Collisions::getCollisionType(vec2& new_pos)
    {
        ...
        if (isGrounded)
        {
            ...
            else if (isNone)        type = TouchType::NoneX;      // <== NoneX
            else if (isIce)         type = TouchType::Ice;       //
            else if (isCollision)   type = TouchType::Collision; // <== Collision
        }
        else
        {
            ...
            else if (isNone)        type = TouchType::None;      // <== None
        }
